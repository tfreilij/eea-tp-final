...
```
```{r}
#Veo qué variables tienen coeficientes de correlación MUY altos
...
roc_todas <- roc(
  response  = modelo_todas$y,          # la y que realmente usó glm()
...
perm_importance <- function(data, model_formula) {
  ...
  # AUC base usando exactamente las filas que usó glm
